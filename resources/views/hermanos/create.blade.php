    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <x-errores />
    <form name="fc" method="POST" action="{{route('hermanos.store')}}" class="p-4" style="background: #ECCCCF;color: black;">
    @csrf
                    ...
                    <form class="form-horizontal" method="post">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="dni" name="dni" placeholder="DNI" maxlength="9" maxlength="9">
                            </div>      
                            <div class="form-group">
                                <label for="city_id" class="control-label"><b><i class="fas fa-calendar-week"></i><b> Fecha Nacimiento</b></label>
                                <input type="date" class="form-control" id="dni" name="fechaNac" placeholder="yyyy/mm/dd" maxlength="8" maxlength="9">
                            </div>     
                            <div class="form-group">
                                <label for="city_id" class="control-label"><b><i class="fas fa-calendar-week"></i><b> Fecha Ingreso</b></label>
                                <input type="date" class="form-control" id="dni" name="fechaIng" placeholder="yyyy/mm/dd" maxlength="8" maxlength="9">
                            </div>     
                            ...
                            <div class="form-group text-center">
                                <div class="mt-3 text-center">
                                    <button type="submit" class="btn btn-success mr-1 ml-1"><i class="fas fa-user-plus"></i> Crear</button>
                                    <button type="reset" class="btn btn-warning mr-1 ml-1"><i class="fas fa-broom"></i> Limpiar</button>
                                    <a class="btn btn-info mr-1 ml-1" href="{{route('hermanos.index')}}"><i class="fas fa-backward"></i> Volver</a>
                                </div>
                                </div>
                        </fieldset>
                    </form>
