        ...
        @endif
            ...
            @if (Route::has('login'))
                    @auth
                        <a href="{{ route('users.index') }}">
                            <i class='fas fa-sign-in-alt'></i>
                            <span class="links_name">Gestionar Cuentas</span>
                        </a>
                        <span class="tooltip">Gestionar Cuentas</span>
                    @else
                        <a href="{{ route('login') }}">
                            <i class='fas fa-sign-in-alt'></i>
                            <span class="links_name">Iniciar Sesión</span>
          ...
          <section class="home-section bg-danger">
            <div class="container" style="text-align: center;">
                <img src="{{ asset('/images/cartel.jpg')}}" alt="" width="50%" height="autos" class="mt-3 mb-3">
            </div>
            <x-footer />
          </section>
